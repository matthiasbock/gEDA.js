(function () {
    ...
    function ui(e, t) {
        ...
        for (;;) {
            ...
            distance(m, o))), a = h, h = r.createHalfEdge(y, "r"), r.insert(a, h), m = i.intersect(h, f), m && s.insert(h, m, i.distance(m, o)), o = n.list.shift();
            else {
                if ( !! s.empty()) break;
    ...
    d3.bisectLeft = Zi.left, d3.bisect = d3.bisectRight = Zi.right, d3.first = function (e, t) {
        ...
        if ((t - e) /n===Infinity)throw new Error("infinite range");var r=[],i=p(Math.abs(n)),s=-1,o;e*=i,t*=i,n*=i;if(n<0)while((o=e+n*++s)>t)r.push(o/i);
