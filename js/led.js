...
LED = function(parentSchematic, debug, randomXY) {
    ...
    this.path = this.parentSchematic.newPathElement(this.name, 'm-30,0 l+20,0 m+20,0 l-20,-10 l0,+20 z m0,-10 l0,+20 m0,-10 l+20,0');
    ...
    this.terminals[0].hookSVG( this.circleAnode = this.parentSchematic.newCircleTerminal('terminalLED') );
    this.terminals[1].hookSVG( this.circleCathode = this.parentSchematic.newCircleTerminal('terminalLED') );
