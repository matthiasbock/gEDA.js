d3 = function () {
        ...
        function interpolate(t) {
            ...
            if (dr) {
                var coshr0 = d3_cosh(r0),
                    u = w0 / (rho2 * d1) * (coshr0 * d3_tanh(rho * s + r0) - d3_sinh(r0));
    ...
    d3.behavior.zoom = function () {
        ...
        function touchstarted() {
            var target = this,
                event_ = event.of(target, arguments),
                locations0 = {}, distance0 = 0,
                scale0, eventId = d3.event.changedTouches[0].identifier,
    ...
    function d3_xhr(url, mimeType, response, callback) {
        var xhr = {}, dispatch = d3.dispatch("beforesend", "progress", "load", "error"),
    ...
    d3.geo.albersUsa = function () {
        ...
        albersUsa.translate = function (_) {
            ...
            alaskaPoint = alaska.translate([x - .307 * k, y + .201 * k]).clipExtent([
                [x - .425 * k + epsilon, y + .12 * k + epsilon],
                [x - .214 * k - epsilon, y + .234 * k - epsilon]
            ]).stream(pointStream).point;
            hawaiiPoint = hawaii.translate([x - .205 * k, y + .212 * k]).clipExtent([
                [x - .214 * k + epsilon, y + .166 * k + epsilon],
                [x - .115 * k - epsilon, y + .234 * k - epsilon]
            ]).stream(pointStream).point;
            return albersUsa;
        };
    ...
    function d3_geo_resample(project) {
        ...
        function resample(stream) {
            ...
            function linePoint(lambda, phi) {
                var c = d3_geo_cartesian([lambda, phi]),
        ...
        function resampleLineTo(x0, y0, lambda0, a0, b0, c0, x1, y1, lambda1, a1, b1, c1, depth, stream) {
            ...
            if (d2 > 4 * delta2 && depth--) {
                var a = a0 + a1,
                    ...
                    phi2 = Math.asin(c /= m),
                    lambda2 = abs(abs(c) - 1) < epsilon ? (lambda0 + lambda1) / 2 : Math.atan2(b, a),
    ...
    function d3_geo_projectionMutator(projectAt) {
        var project, rotate, projectRotate, projectResample = d3_geo_resample(function (x, y) {
            ...
            deltaphi = 0,
            deltagamma = 0,
            deltax, deltay, preclip = d3_geo_clipAntimeridian,
    ...
    var d3_svg_arcOffset = -halfpi,
        d3_svg_arcMax = tau - epsilon;
        ...
        function axis(g) {
            g.each(function () {
                ...
                var ticks = tickValues == null ? scale1.ticks ? scale1.ticks.apply(scale1, tickArguments_) : scale1.domain() : tickValues,
                    ...
                    tickExit = d3.transition(tick.exit()).style("opacity", epsilon).remove(),
